...
- **Tools:** 8 `omt_*` — catalog `omt_nav{query:"CMD_", tag_type:"CMD"}` · workflows `omt_quick_ref`
...
- **Projects home (.projects/):** .projects/ per-feature design & project home — non-gated; PROJECT.md (canonical) + CURRENT_STATE.md (session log); companion to @phase design_doc. Detail: @doc comp.projects + .projects/meta/.
