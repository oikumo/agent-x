...
| Analysis on mined net | `PetriNetAnalyzer.reachable_markings/deadlocks/place_invariants` (99 tests) consume the mined net unchanged — prediction + counterfactual + empirical invariants are free | **High — no analysis extension** |
