...
WORK_BUDGET = 6144          # read at every session startup (feature_kb_akb: +1 task → 5120; feature_038 active row → 5632; feature_039 pause line + project-link row → 6144 — .omt @budget work_md=6144 is the source of truth)
